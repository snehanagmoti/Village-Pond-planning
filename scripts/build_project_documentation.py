...
def add_report_body(doc: Document, lines: list[str], headings: list[tuple[int, str, str]], bullet_id: int, number_id: int, decimal_abstract_id: int) -> None:
    ...
    figure_map = {
        ...
        "9. Frontend and visualization": [("production-home.png", "Production home and live-analysis interface", "Full application view with India satellite map and the responsive live-analysis panel."), ("production-contour-result.png", "Production contour result workspace", "Contour upload result showing uploaded extent, reconstructed contour lines, selected catchment, drainage evidence, and numbered alternatives." )],
    }
